...
export default function ProductPage( props ) {
  ...
  const headData = {
    title: `${product.name} - ${product.productCategories.nodes[0].name} - BERRE Furniture`,
    meta : `Shop ${product.name} - ${product.productCategories.nodes[0].name} at BERRE Furniture. Find ${product.productCategories.nodes[0].name} with Canada-Wide Furniture Delivery.`
    // meta : "BERRE - META"
  } 
   
    // add this:  title : `${product.name} - ${product.parentCat} - BERRE Furniture`,
  ...
  return( 
    <>
      ...
      <section className="section product__single__wrap">
        <div className="container">
          <div className="hero__breadcrumbs">
            ...
            <Link href={`/products`}><a><p>Products</p></a></Link>
            <p className="bc__div">/</p>
            <Link href={`/products/${product.productCategories.nodes[0].slug}`}><a><p>{product.productCategories.nodes[0].name}</p></a></Link>
            <p className="bc__div">/</p>
            <Link href={`/products/${product.productCategories.nodes[0].slug}/${product.slug}`}><a className="__current"><p>{product.name}</p></a></Link>
          </div>
                  ...
                  <div className="desc__rates">
                    ...
                    <div className="desc__buy">
                      <div className="desc__price-wrap">
                        {
                          ...
                          <div className="desc__price-wrap">
                            <h6 className="desc__price-txt">Price:</h6>
                          ...
                          <>
                            <h6 className="desc__price-txt">Price:</h6>
                            <p className="desc__price __alt">{"choose an option"}</p>
                          </>
                        }
                      ...
                      </div>
                      {
                        ...
                        :
                        <button className="button product-single__cart __inactive"> <img src="/cart.svg" alt="" /> Add to cart</button>
                      }
                  ...
                  <div className="desc__more-drop">
                    ...
                    </div>
                    {
                      ...
                      <div className="desc__more-drop-content">
                        <Link href={`https://www.youtube.com/watch?v=BCNSZsTk5FE&ab_channel=BerreFurnitureCanada`} ><a target="_blank">Assembly Instructions</a></Link>
                      </div>
                      :
                      ""
                    }
                  ...
                  <div className="desc__more-drop">
                    ...
                    </div>
                    {
                      ...
                      <div className="desc__more-drop-content">
                        ...
                        <Link href="/policies"><a>Shipping Policy</a></Link>
                      </div>
                      :
                      ""
                    }
      ...
      <section className="section">
        <div className="container">
          <ProductSlider title={"Simmilar products"} products={product.related.nodes}/>
        </div>
      </section>
